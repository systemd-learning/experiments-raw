...
define linux/build :=
	...
	+$(CROSS_ENV_RAW) $(MAKE) ARCH=$(ARCH) CROSS_COMPILE=$(CROSS_NAME)- $(IMG) modules dtbs tools/perf -j 8
endef
...
#	+cd $(linux/dir)/../build/source/tools
#	+$(CROSS_ENV_RAW) make ARCH=$(ARCH) CROSS_COMPILE=$(CROSS_NAME)- prefix=$(HOST)/sysroot/usr/ perf_install
endef
